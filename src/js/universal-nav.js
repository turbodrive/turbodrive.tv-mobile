    ...
    $(window).load(function () {
        ...
        var closeButton = $("#close-button"),
            ...
            init = function () {
                ...
                if (isBlog) {
                    closeButton.click();
                    setTimeout(autoOpenSubMenu, 550);
                }
            };
        ...
        openButton.click(function () {
            ...
            if (isBlog) {
                setTimeout(autoOpenSubMenu, 700);
            }
        });
        ...
        blogButton.parent().click(
            function () {
                ...
                mainMenu.toggleClass("open-submenu");
                submenuIsOpen = mainMenu.hasClass("open-submenu");
                updateSubMenuHeight();
                updateBrandPadding();
            }
        );
